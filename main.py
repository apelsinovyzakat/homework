...
cv2.imwrite("rotated_angle.jpg", rotated_angle)
...
cv2.imwrite("red_tint.jpg", red_tint)
cv2.imwrite("green_tint.jpg", green_tint)
cv2.imwrite("blue_tint.jpg", blue_tint)
cv2.imwrite("sepia.jpg", sepia)
cv2.imwrite("saturated.jpg", saturated)
cv2.imwrite("desaturated.jpg", desaturated)
